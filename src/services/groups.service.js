...
export const useGetGroupsUsers = (params) => {
  return useQuery({ queryKey: ['GET/GROUPS/USERS', params], queryFn: () => groupsServices.getGroupsUsers(params) });
};

export const useGetGroupsId = ({courseId}) => {
  return useQuery({ queryKey: ['GET/GROUPS/ID', courseId], queryFn: () => groupsServices.getGroupsId(courseId), enabled: !!courseId});
};
