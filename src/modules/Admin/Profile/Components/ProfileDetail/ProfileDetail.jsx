...
export const ProfileDetail = () => {
  ...
  return (
    <Box className={cls.wrapper}>
      <DetailHeader title='Изменить профиль' />
          ...
          <Box className={cls.inputEditerBox}>
            <Box>
              <Box display={'block'} marginTop={10}>
                ...
                <Inputs id="name" type="text" placeholder="Введите e-mail" register={register} name="first_name" />
              </Box>
              <Box display={'block'} marginTop={10}>
                ...
                <Inputs id="name" type="number" register={register} name="phone_number" />
              </Box>
            ...
            <Box>
              <Box display={'block'} marginTop={10}>
                ...
                <Inputs id="name" type="text" register={register} name="last_name" />
              </Box>
              <Box display={'block'} marginTop={10}>
                <label className={cls.lable} htmlFor="first_name">
                  Адресс почты
                ...
                <Inputs id="name" type="email" placeholder="Введите e-mail" register={register} name="email" />
              </Box>
            </Box>
          </Box>
        </FormControl>
